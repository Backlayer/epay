...
@section('content')
    <div class="row justify-content-center">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('user.single-charges.update', $singleCharge->id) }}" method="post"
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" class="form-control"
                                    value="{{ $singleCharge->title }}" placeholder="{{ __('Payment Title') }}" required>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="any" class="form-control" name="amount"
                                value="{{ $singleCharge->amount }}" placeholder="0.00">
                        </div>
                        <span
