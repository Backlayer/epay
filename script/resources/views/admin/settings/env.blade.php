                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-4">
                        <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab4" data-toggle="tab" href="#pusher" role="tab" aria-controls="driver" aria-selected="false">{{ __('Pusher Settings') }}</a>
                            </li>
                    ...
                    <div class="col-12 col-sm-12 col-md-8">
                        ...
                        <div class="tab-content no-padding" id="myTab2Content">
                            <div class="tab-pane fade show active" id="home4" role="tabpanel" aria-labelledby="home-tab4">
                                ...
                                <div class="form-group">
                                    <label>{{ __('KYC_MUST_VERIFIED') }}</label>
                                    <select class="form-control" name="KYC_MUST_VERIFIED">
                                        <option value="true" @if(env('KYC_MUST_VERIFIED') == true) selected @endif>true</option>
                                        <option value="false" @if(env('KYC_MUST_VERIFIED') == false) selected @endif>false</option>
                                    </select>
                                </div>
                            ...
                            <div class="tab-pane fade" id="pusher" role="tabpanel" aria-labelledby="profile-tab4">
                             ...
                             <div class="tab-pane fade" id="social" role="tabpanel" aria-labelledby="profile-tab4">
                                ...
                                <div class="form-group">
                                    <label>{{ __('GITHUB_CLIENT_ID') }}</label>
                                    <input type="text"  name="GITHUB_CLIENT_ID" class="form-control" value="{{ env('GITHUB_CLIENT_ID') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('GITHUB_CLIENT_SECRET') }}</label>
