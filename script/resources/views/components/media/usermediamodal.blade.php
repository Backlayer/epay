...
<div class="modal fade bd-example-modal-xl media-single" tabindex="-1" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true" data-backdrop="false">
            ...
            <div class="modal-body">
                <div class="tab-content" id="myTabContent2">
                    <div class="tab-pane fade show active" id="upload_area" role="tabpanel" aria-labelledby="home-tab3">
                        <form method="post" action="{{ route('user.media.store') }}" class="dropzone dropzones">
                            @csrf
                            <div class="fallback">
                    ...
                    <input type="hidden" class="media_url" value="{{ route('user.media.index') }}">
