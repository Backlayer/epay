        ...
        <div class="requirments-section">
            <div class="content-requirments d-flex justify-content-center">
                <div class="requirments-main-content">
                        ...
                        <tbody>
                            ...
                            @foreach ($permissions['permissions'] as $row)
                                @if ($row['isSet'] == false)
                                    ...
                                    @endphp
                                    <tr>
                                        <td>{{ $row['folder'] }} <br><small>solution: run this command <br><span
                                                    class="text-danger">chmod -R 775
                                                    {{ $row['folder'] }}</span></small></td>
                    ...
                    <a href="{{ url('install/info') }}"
                        class="btn btn-primary install-btn f-right">{{ __('Next') }}</a>
                    <?php
                    } else { ?>
