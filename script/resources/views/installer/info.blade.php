                    ...
                    <form action="{{ url('install/store') }}" method="POST" id="install">
                        ...
                        <div class="custom-form install-form">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="app_name" name="app_name"
                                            required placeholder="App Name without space">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type" id="type">
                                            <option value="install" class="install_option">
                                                {{ __('I Want To Install') }}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="mysql" class="form-control" id="db_connection"
                                            name="db_connection" required placeholder="Database Connection">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="db_host">{{ __('Database Host') }}</label>
                                        <input type="text" value="localhost" class="form-control" id="db_host"
                                            name="db_host" required placeholder="Database Host">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="db_port">{{ __('Database Port') }}</label>
                                        <input type="text" value="3306" class="form-control" id="db_port"
                                            name="db_port" required placeholder="Database Port">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="hidden" value="{{ url('/') }}" class="form-control none"
                                            id="app_url" name="app_url" required placeholder="App Url">
                                        <input type="hidden" id="migrate_url"
                                            value="{{ url('/install/migrate') }}">
                        ...
                        <button type="submit"
                            class="btn btn-primary install-btn f-right">{{ __('Save & Install') }}</button>
                    </form>
                </div>
            </div>
        </div>
