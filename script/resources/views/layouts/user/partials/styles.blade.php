...
<!-- Argon CSS -->
<link rel="stylesheet" href="{{ asset('user/css/argon.css?v=' . config('app.version')) }}" type="text/css">
...
<link rel="stylesheet" href="{{ asset('user/custom.css?v=' . config('app.version')) }}">
